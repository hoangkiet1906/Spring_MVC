...
// Example 1
var rangeInput1 = document.querySelector('.js-price-range-slider-1');

noUiSlider.create(rangeInput1, {
...
rangeInput1.noUiSlider.on('change', function(values, handle) {
...
rangeInput2.noUiSlider.on('slide', function(values, handle) {
  rangeValue1.innerHTML = parseInt(values[0]) + ' kr';
  rangeValue2.innerHTML = parseInt(values[1]) + ' kr';
});
