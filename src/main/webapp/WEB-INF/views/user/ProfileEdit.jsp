	...
	<div id="hero" style="height: 120vh">
		<div>
			<div class="chai4"
				...
				<div class="containeri4 containeri6">
					<form action="<c:url value="/ProfileEdit" />" method="post">
						<div class="wrapperi4" style="margin-bottom: 40px">
							<div class="titlei4"
								style="margin-top: 20px; margin-bottom: 26px">Cập Nhật
								Thông Tin</div>
							<input id="inputin4" type="text" name="name"
								placeholder="Họ và tên"> <input
								style="margin-left: -35px;" id="inputin4" type="date"
								name="date" placeholder="Ngày sinh"> <input
								id="inputin4" type="text" name="sdt" placeholder="Số điện thoại">
							<input id="inputin4" type="email" name="email"
								placeholder="Email"> <input id="inputin4" type="text"
								name="diachi" placeholder="Địa Chỉ"> <input
								id="inputin4" type="type" name="work" placeholder="Nghề nghiệp">
							<input style="margin-bottom: 0px" id="inputin4" type="type"
								name="kynang" placeholder="Kỹ Năng">

						</div>
						<div class="contenti4">
							<div class="buttonsi4">
								<div class="btni4">
									<button type="submit" class="bi4">OK</button>
								</div>
								<div class="btni4">
									<a href="Profile.html"><button class="bi4"
											style="font-size: 17px; font-weight: 500; font-family: 'Poppins', sans-serif;">Thoát</button></a>
								</div>
							</div>
						</div>
					</form>
			...
			<div style="width: 400px; height: 450px; margin: 20px; float: right;">
				...
				<div
					...
					<p
						...
						<i>Xem các khóa học đã mua : </i><a href="CartOK.html"
