						...
						<div class="col-lg-6">
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">
										<i class="ion ion-clipboard mr-1"></i> Danh Sách Bài Viết
									</h3>
								...
								<div class="card-body">
									<ul class="todo-list" data-widget="todo-list">
										<li>
											...
											</div> <!-- todo text --> <span class="text">Thiết kế trang
												chủ website</span> <!-- Emphasis label --> <small
										...
										<li>
											...
											</div> <span class="text">Học Java cùng với giáo sư Kiệt</span> <small
										...
										<li>
											...
											</div> <span class="text">Cách học Java hiệu quả</span> <small
										...
										<li>
											...
											</div> <span class="text">Hướng dẫn sử dụng Github</span> <small
										...
										<li>
											...
											</div> <span class="text">Cấu trúc dữ liệu và giải thuật</span> <small
										...
										<li>
											...
											</div> <span class="text">Các sử dụng VScode hiệu quả</span> <small
								...
								<div class="card-body">
									<div
										...
										<p class="d-flex flex-column text-right">
											...
											</span> <span class="text-muted">Tỉ Lệ Đăng Bài</span>
										</p>
									</div>
									<!-- /.d-flex -->
									<div
										...
										<p class="d-flex flex-column text-right">
											...
											</span> <span class="text-muted">Tỉ Lệ Người Đùng Xem</span>
										</p>
									</div>
									<!-- /.d-flex -->
									<div
			...
			<div class="container">
				<div class="row">
					...
					<div class="footer-col">
						...
						<img src="<c:url value="/resourcesUser/Admin/team.png" />"
