		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a href="<c:url value="/QLS" />"
							...
							<div class="card">
								...
								<div class="card-body table-responsive p-0">
									<table class="table table-striped table-valign-middle">
										...
										<tbody>
											<tr>
												<td><img src="<c:url value="/resourcesUser/Admin/dist/img/default-150x150.png" />"
											...
											<tr>
												<td><img src="<c:url value="/resourcesUser/Admin/dist/img/default-150x150.png" />"
													alt="Product 1" class="img-circle img-size-32 mr-2">
													JavaScript <span class="badge bg-danger">NEW</span></td>
												<td>225</td>
												<td>88k</td>
												<td><small class="text-success"> <i
								...
								<div class="card-body">
									...
									<div
										...
										<p class="d-flex flex-column text-right">
											...
											</span> <span class="text-muted">Tỉ Lệ Người Đùng Đọc Sách</span>
										</p>
									</div>
